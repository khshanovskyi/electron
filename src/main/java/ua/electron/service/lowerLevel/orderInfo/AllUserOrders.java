...
public class AllUserOrders {
    ...
    public List<FullOrderInfo> getAllUserOrders(IOrderDao orderDao, int userId, IUserDao userDao, IProductDao productDao) {
        clearAllOrderList();
        List<Order> orderList = orderDao.allUserOrdersInfo(userId);
