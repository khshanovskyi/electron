...
public class UserOrdersWithStatusInProcessing {
    ...
    public List<FullOrderInfo> getAllUserOrdersWhereStatusIs(IOrderDao orderDao, int userId, IUserDao userDao,
        ...
        clearAllOrderList();
        List<Order> orderList = orderDao.allUserOrdersInfoWithSearchingStatus(userId,String.valueOf(Constant.IN_PROCESSING));
