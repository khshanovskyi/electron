...
public class UserOrdersWithStatusWaitingAnswer {
    ...
    public List<FullOrderInfo> getAllUserOrdersWhereStatusWaitingAnswer(IOrderDao orderDao, int userId, IUserDao userDao,
                                                                        IProductDao productDao) {
        clearAllOrderList();
        List<Order> orderList = orderDao.allUserOrdersInfoWithSearchingStatus(userId, String.valueOf(Constant.WAITING_ANSWER));
